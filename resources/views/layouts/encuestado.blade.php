...
<head>
    ...
    <title>@yield('title', 'SIGO - Consulta')</title>
        ...
        <nav id="sidebar">
            ...
            <div class="py-3">
                ...
                <ul class="list-unstyled mb-0">
                    {{-- 1. Inicio --}}
                <li>
                    <a href="{{ route('encuestado.mi_puntaje') }}" class="nav-link-sidebar {{ request()->routeIs('encuestado.mi_puntaje') ? 'active' : '' }}" title="Inicio">
                    ...
                    {{-- 2. Mi Consulta --}}
                    <li>
                        <a href="{{ route('encuestado.mi_puntaje') }}" class="nav-link-sidebar {{ request()->routeIs('encuestado.mi_puntaje') ? 'active' : '' }}" title="Mi Consulta">
                            <i class="bi bi-search"></i>
                            <span class="sidebar-text ms-3">Mi Consulta</span>
                        </a>
                    </li>
                    {{-- 3. PQRS --}}
                    <li>
                        <a href="{{ url('/pqrs') }}" class="nav-link-sidebar {{ request()->is('pqrs*') ? 'active' : '' }}" title="PQRS">
                            <i class="bi bi-envelope-paper-fill"></i>
                            <span class="sidebar-text ms-3">PQRS</span>
                        </a>
                    </li>
                </ul>
            </div>
